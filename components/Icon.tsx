...
/**
 * Minimal inline icon set (stroke-based, 24x24, currentColor) so we avoid an
 * icon-library dependency. Add new paths to `paths` as needed.
 */
const paths: Record<string, React.ReactNode> = {
  ...
  whatsapp: (
    <>
      <path d="M3 21l1.65-4.5A8.5 8.5 0 1 1 12 20.5a8.4 8.4 0 0 1-4-1L3 21Z" />
      <path d="M9 9.5c0 3 2.5 5.5 5.5 5.5.6 0 1-.5 1-.5l-1.3-1.3-1.2.6c-1-.4-1.9-1.3-2.3-2.3l.6-1.2L10 9s-.5-.4-1 0c0 .2 0 .4 0 .5Z" />
    </>
  ),
  download: (
    <>
...
export function Icon({ name, size = 20, strokeWidth = 1.75, ...props }: IconProps) {
  ...
  const filled =
    name === "github" || name === "apple" || name === "googleplay";
  return (
    <svg
